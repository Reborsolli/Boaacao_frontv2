...
export class PostagemService {
  ...
  getAllPostagens(): Observable<Postagem[]>{
    return this.http.get<Postagem[]>('https://blogrenata.herokuapp.com/postagens', this.token)
  }
  ...
  putPostagem(postagem: Postagem): Observable<Postagem>{
    return this.http.put<Postagem>('https://blogrenata.herokuapp.com/postagens', postagem, this.token)
  }

  deletePostagem(id: number) {
    return this.http.delete(`https://blogrenata.herokuapp.com/postagens/${id}`, this.token)
  }
}
